export default {
  ...
  pages: {
    ...
    changedSettings: {
      ...
      warningBody:
        'Некоторые настройки не поддерживаются сервисами {{appName}}. Ожидайте проблемы с подключением и самый низкий приоритет от нашей команды поддержки.'
    },
    settings: {
  ...
  modal: {
    ...
    confirmQuit: 'Вы уверены, что хотите выйти из {{appName}}?',
  ...
  mihomo: {
    ...
    serviceModal: {
      title: 'Управление службой {{appName}}',
